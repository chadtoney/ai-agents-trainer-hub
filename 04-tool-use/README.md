...
The Python Agent Framework notebook demonstrates advanced tool integration patterns with comprehensive examples:

- **Python: [Agent Framework with GitHub Models](./code_samples/04-python-agent-framework.ipynb)** ⭐ **Free tier available!**
  - Uses GitHub Models (free with GitHub account)
  - Weather forecasting tool with structured output
  - Code Interpreter tool for mathematical calculations
  - Azure AI Search integration with semantic search
  - Multiple tool orchestration examples

- **.NET: [Agent Framework](./code_samples/04-dotnet-agent-framework.md)**

> **💡 Note for Students:** The Python notebook uses GitHub Models which provides free access to GPT-4o-mini and other models. You'll need:
> - A GitHub account and personal access token (free)
> - Environment variables: `AZURE_AI_PROJECT_ENDPOINT`, `AZURE_AI_MODEL_DEPLOYMENT_NAME`
> - For Azure AI Search examples: `AI_SEARCH_PROJECT_CONNECTION_ID`, `AZURE_SEARCH_SERVICE_ENDPOINT`, `AZURE_SEARCH_API_KEY`
>
